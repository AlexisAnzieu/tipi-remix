...
const enigme: Record<number | string, string> = {
    42: "Tu souhaites explorer le site d'atterrissage ? Avant toute chose, munissons-nous d'eau potable. Où pourrait-on bien en trouver...",
    ...
    9345: "Le cheval est bien ici ! Mais quel boucan ! À quoi sert donc cette machine infernale ? Suivons le cable jusqu'à trouver un indice",
    9111: "Hmm c'est le bon cable bleu mais ce n'est pas un vrai indice. Continuons à chercher !",
